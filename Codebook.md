...
* Appropriately labeling the data set with descriptive variable names and getting the mean value of each group.
* All of the result (tidy data set) are saved in the file `tidy_dataset.txt`.
